...
export default function SeminoleCounty() {
  return (
    <div className="container" style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        <main className="main-content" style={{ padding: '40px 32px 0 32px', flex: 1 }}>
          <Header />
          <h2>Seminole County, FL Foreclosure List</h2>
          <div style={{ display: 'flex', flexDirection: 'row', gap: 40, alignItems: 'flex-start', marginBottom: 24 }}>
            ...
            <div style={{ flex: 1, minWidth: 320 }}>
              ...
              <div className="highlight-box">
                <p>Get the latest list of foreclosure properties in Seminole County, FL. Updated weekly!</p>
              </div>
            </div>
          </div>
        </main>
        <footer className="footer">
          ...
          <div>©{new Date().getFullYear()} Seminole County Foreclosure List. All rights reserved.</div>
        </footer>
      </div>
    </div>
  );
