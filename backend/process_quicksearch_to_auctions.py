...
def parse_filename(filename):
    # Example: Pasco-20251115_QuickSearch.csv
...
def main(csv_path):
    county, date = parse_filename(csv_path)
    total = 0
    written = 0
    skipped = 0
